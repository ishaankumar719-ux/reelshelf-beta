...
const styles = StyleSheet.create({
  ...
  cinemaBadgeLabel: { fontSize: RS.typography.micro, fontWeight: '700', color: RS.colors.accent, textTransform: 'uppercase', letterSpacing: 0.3 },
  ...
  gifBadgeLabel: { fontSize: RS.typography.micro, fontWeight: '700', color: '#fff', letterSpacing: 0.5 },
  ...
  statLabel: { fontSize: RS.typography.micro, fontWeight: '600', color: RS.colors.textMuted, textTransform: 'uppercase', letterSpacing: RS.letterSpacing.wide, marginTop: 1 },
});
